...
def update_line(line):
    ...
    if stripline[:len(PRINT)] == PRINT:
        ...
        # print("Length of spaces = " + str(len(spaces)))
...
def update_file(input_file_name, output_file_name):
    ...
    for part in parts[1:]:
        # print("Got here too")
        print("Updated Text1: " + updated_text)
        updated_text += PREFIX  # updated_text = updated_text + PREFIX
        [pre_block, filler] = part.split(POSTFIX, 1)  #max split is 1 after </pre> tags found
        ...
        print("Append POSTFIX: " + updated_text)
        updated_text += filler
        print("Append filler: " + updated_text)
